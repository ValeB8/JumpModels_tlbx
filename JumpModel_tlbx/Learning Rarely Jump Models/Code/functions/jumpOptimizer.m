function [theta_opt,s,frequences,cost,mean_filling,mean_eval,eval_time]=jumpOptimizer(y,X,K,f,param,rgl,cons0,opt)
...
if opt.check
    ...
    warning('The fields of opt have not been checked.');
end
    ...
    switch opt.showCon
        ...
        case true
            ...
            for iter=1:opt.maxiter
                ...
                filling_matrix(iter)=time_filling;
                [s,~,evaluate_path(iter)]=dp_path_mex(T,K,l,frequences);
                [opt_c1,opt_models1,opt_switch1]=costEvaluation2_mex(T,K,y,X,theta_opt,s,frequences,rgl.c);
