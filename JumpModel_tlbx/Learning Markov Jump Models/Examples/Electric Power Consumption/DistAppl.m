...
%Load the data and the models obtained running EnergyPattern.m
load('EstEnergyPattern.mat')
...
for wind=1:num_wind
    ...
    for j=1:4
        [~,~,BFR_predComb{wind,j}]=ValMJLS(K(j),0,yval,Phival,theta{j},transition{j},var_error{j});
