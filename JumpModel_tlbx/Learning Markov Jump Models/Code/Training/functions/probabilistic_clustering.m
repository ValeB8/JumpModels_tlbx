function [curr_mode,prob,alphaup]=probabilistic_clustering(Y,X,s,w,variance,alpha_update,Pi)
...
for n=1:Nf % go through all data
    ...
    for k=1:s
        e2=(e(:,k))'*(S)^(-1)*(e(:,k)); % vector of dimension s with normalized norms^2 of y(n)-w(:,:,k)'*x, k=1,...,s
